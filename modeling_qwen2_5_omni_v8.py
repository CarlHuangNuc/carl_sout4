...
class Qwen2_5OmniForConditionalGeneration(Qwen2_5OmniPreTrainedModel, GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        while thinker_get_tokens.shape[1] <= carl_custom_thinker_tokens and thinker_get_tokens.shape[1] >= 2  and thinker_total_tokens < 2000:
            merged_tokens = torch.cat(thinker_full_tokens, dim=-1)
            
            # 2. Generate speech tokens from talker module
            embeds_to_talker = thinker_full_hidden_states[0][0].clone().to(input_ids.device)
